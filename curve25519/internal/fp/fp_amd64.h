...
// Size is the size in bytes of an element of GF(2^255-19).
#define Size 32
...
// multiplyA24Leg multiplies x times a24 and stores in z
// Uses: AX, DX, R8-R13, FLAGS
// Instr: x86_64, cmov
#define multiplyA24Leg(z,x,a24) \
    MOVL $a24, AX; MULQ  0+x; MOVQ AX,  R8; MOVQ DX,  R9; \
    MOVL $a24, AX; MULQ  8+x; MOVQ AX, R12; MOVQ DX, R10; \
    MOVL $a24, AX; MULQ 16+x; MOVQ AX, R13; MOVQ DX, R11; \
    MOVL $a24, AX; MULQ 24+x; \
    ADDQ R12,  R9; \
    ADCQ R13, R10; \
    ADCQ  AX, R11; \
    ADCQ  $0,  DX; \
...
// multiplyA24Adx multiplies x times a24 and stores in z
// Uses: AX, DX, R8-R12, FLAGS
// Instr: x86_64, cmov, bmi2
#define multiplyA24Adx(z,x,a24) \
    MOVQ  $a24, DX; \
    MULXQ  0+x,  R8, R10; \
